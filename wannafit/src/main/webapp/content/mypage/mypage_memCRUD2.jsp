...
console.log("[마이페이지 - 회원 정보 수정] 유저세션 : " + userSession);
console.log("[마이페이지 - 회원 정보 수정] 유저그룹세션 : " + usrGrp);
...
<%-- 		<li id="trauth"><a href="${path}/mytr.do"> 예약 내역 </a></li>
 			<li id="trauth"><a href="${path}/mytr.do?proc=예약일정"> 예약일정 관리 </a></li> --%>
		</ul>
	</div>		
	</aside>
	...
	<div class="main-container">
			...
			<table id="show" align="center" width="450px">
				<thead>
					<tr><th> 아이디 </th><td><input type="text" name="wm_id" value="${login_User}" readonly/></td></tr>
				</thead>
				<tbody>
