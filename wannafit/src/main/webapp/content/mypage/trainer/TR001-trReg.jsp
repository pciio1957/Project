...
<section class="section">
    <div align="center">
        <form id="regfrm" method="post" enctype="multipart/form-data" action="${path}/trCRUD.do">
        	<input type="hidden" name="proc"/>
        	<table id="reg-table">
        		<thead>
	        		<tr align="center">
	        			<td colspan="2"><b>트레이너 가입</b></td>
	        		</tr>
        		</thead>
        		<tr>
        		...
        		<tr>
        			...
        			<td><input type="text" name="wm_tel" size="20" value="" required/></td>
        		</tr>
        		<tr>
        			<td class="comInfo">이메일</td>
        			<td><input type="text" name="wm_email_id" size="10" placeholder="이메일 아이디" required> @ 
        					<input type="text" name="wm_email_addr" size="10">
        		...
        		<tr><td>
        			<label for="my_image2">프로필 이미지</label>
        			</td>
        			<td><input type="file" id="my_image2" 
        				name="wm_imgSrc" placeholder="추천 사이즈 : 20x25"/></td>
        		</tr>
        		<tr><td>트레이너 소개</td>
        		<td><textarea name="wt_info" cols="40" rows="3" 
        			placeholder="트레이너 소개" ></textarea></td>
        		</tr>
        		<tr>
        			<th id="reg-choice" colspan="2" align="center">
